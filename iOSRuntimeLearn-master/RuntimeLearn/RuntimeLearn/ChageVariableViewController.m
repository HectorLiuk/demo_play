...
//    [self performSelector:sel_getName(<#SEL sel#>) withObject:nil afterDelay:0];
    [self performSelector:@selector(add) withObject:nil];

    
    const char *c = sel_getName(@selector(add));
    
    objc_msgSend(self,sel_registerName(c));
